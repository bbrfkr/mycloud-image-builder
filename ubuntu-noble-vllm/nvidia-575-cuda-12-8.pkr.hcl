...
locals { 
  ...
  vllm_install_script = "01-vllm-cuda-12-8.sh"
}

source "openstack" "ubuntu-noble-vllm" {
  flavor              = "p1.xlarge"
  image_name          = "ubuntu-noble-vllm-nvidia-575-cuda-12-8-${local.buildtime}"
  source_image_name   = "ubuntu-noble-gpu-nvidia-575-cuda-12-8-20250824-1345"
  ssh_username        = "ubuntu"
